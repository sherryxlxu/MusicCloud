...
//    private NavigationView navigationView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Set the post Id
//        this.postId = "-Mzxvh57q8aioVtBv8VZ"; // sunroof
        postId = getIntent().getExtras().getString("postId");

        // Set the current user
        currUser = new User("TestUser1", "1234");
        ...
        navBarLayout = (Toolbar) findViewById(R.id.navbar);
...
//
//        menu = (ImageButton)findViewById(R.id.navMenu);
...
//    private void navigation(Toolbar navBarLayout) {
//        if (navBarLayout != null){
//            setSupportActionBar(navBarLayout);
//            navBarLayout.setNavigationIcon(R.drawable.ic_baseline_menu_24);
//            toggle = new ActionBarDrawerToggle(this,drawerLayout,navBarLayout,R.string.open,R.string.close){
//                @Override
...
//    }
    ...
    private void postComment() {
        ...
        personalReference.push().setValue(comment);
